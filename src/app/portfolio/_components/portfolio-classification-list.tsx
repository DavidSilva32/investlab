  ...
  return (
    ...
    >
      ...
      <div className="grid gap-3 rounded-lg border p-3 sm:p-4">
        ...
        <div className="grid gap-3 rounded-md bg-muted/40 p-3 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {enabledBulkFields.has("assetClass") && (
            <div className="grid gap-1.5">
              ...
              <Select value={bulkAssetClass} onValueChange={setBulkAssetClass}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value={unknownValue}>Não informado</SelectItem>
          ...
          {enabledBulkFields.has("subClass") && (
            <div className="grid gap-1.5">
              <Label htmlFor="bulk-sub-class">Subclasse em lote</Label>
              <Input
                id="bulk-sub-class"
                value={bulkSubClass}
                onChange={(event) => setBulkSubClass(event.target.value)}
                maxLength={120}
          ...
          {enabledBulkFields.has("geography") && (
            <div className="grid gap-1.5">
              ...
              <Select value={bulkGeography} onValueChange={setBulkGeography}>
